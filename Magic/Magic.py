...
class Magic:
    ...
    def __init__(self, circuit : Circuit, path = None):
        ...
        if circuit._process == None:
            ...
            circuit._process = pexpect.spawn(magiccmd, magicargs, cwd = path, env=my_env)
